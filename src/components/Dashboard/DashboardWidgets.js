      ...
      <div className="flex flex-wrap">
        <div className="w-full mb-3 md:w-1/2">
          <div className="p-4 bg-white rounded-xl md:mr-4 hover:shadow-sm">
            <div className="font-title"> Balance</div>
        ...
        <div className="w-full mb-3 md:w-1/2">
          <div className="p-4 bg-white rounded-xl hover:shadow-sm">
            <div className="font-title">Products and Services</div>
            <div className="flex justify-between items-center">
              {/* Icon */}
              <div className="h-30">
        ...
        <div className="w-full mb-3 md:w-1/2">
          <div className="p-4 bg-white rounded-xl md:mr-4 hover:shadow-sm">
            <div className="font-title">Invoices</div>
            <div className="flex justify-between items-center">
              {/* Icon */}
              <div className="h-30">
        ...
        <div className="w-full mb-3 md:w-1/2">
          <div className="p-4 bg-white rounded-xl hover:shadow-sm">
            <div className="font-title">Clients</div>
            <div className="flex justify-between items-center">
              {/* Icon */}
              <div className="h-30">
