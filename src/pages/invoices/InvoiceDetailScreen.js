...
function InvoiceDetailScreen(props) {
  ...
  const openSettingModal = useCallback(() => {
    if (invoiceForm.statusIndex !== "1" && isViewMode) {
      toast.warn("You can only change settings in 'Draft' mode.", {
        position: "bottom-center",
        autoClose: 3000,
      });
      return;
  ...
  const totalPercentTax = useMemo(() => {
    ...
    return findIndex !== -1
      ? Number.isInteger(invoiceForm.taxes[findIndex].amount)
        ...
        : invoiceForm.taxes[findIndex].amount.toFixed(4).slice(0, -2)
      : 0;
  }, [invoiceForm]);
  ...
  useEffect(() => {
    if (selectedProduct !== null) {
      // If Choosen existing Client And This form is news
  ...
  useEffect(() => {
    ...
    if (params.id === "new" && invoiceForm !== null) {
      ...
      dispatch(updateexistingInvoiceForm(invoiceForm));
    }
        ...
        <PageTitle
          title={
            <>
              {params.id === "new"
                ? "New Invoice"
                : `Invoice Status ${invoiceForm?.statusName}`}
            </>
          }
        />
      </div>
          ...
          >
            ...
            >
              ...
              >
                ...
                <p className="text-sm font-medium">
                  {invoiceForm?.companyDetail?.companyMobile || "Phone Number"}
                </p>
                <p className="text-sm font-medium">
          ...
          >
            <div className="flex-1">
              <div className="flex flex-row">
                <div className="font-title font-bold">Bill to:</div>
                <div className="w-1/2 relative ml-3" style={{ top: "-3px" }}>
                  {!isViewMode && (
                    <Button size="sm" outlined={1} onClick={openChooseClient}>
                      <ClientPlusIcon className="w-4 h-4" /> Add Existing Client
                    </Button>
                  )}
                </div>
              </div>
            ...
            <div className="flex-1">
              ...
              <div className="flex flex-row justify-between items-center mb-1">
                <div className="font-title flex-1"> Date Created </div>
                <div className="font-title flex-1 text-right">
                  <DatePicker
              ...
              <div className="flex flex-row justify-between items-center mb-1">
                <div className="font-title flex-1"> Date Due </div>
                <div className="font-title flex-1 text-right">
                  <DatePicker
              ...
              >
                ...
                {!isViewMode && (
                  ...
                  >
                    <div className="w-full text-red-500 font-title h-8 sm:h-8 sm:w-8 cursor-pointer rounded-2xl bg-red-200 mr-2 flex justify-center items-center">
                      <DeleteIcon className="h-4 w-4" style={IconStyle} />
                      <span className="block sm:hidden">Remove Tax</span>
                    </div>
                  </div>
                )}
              </div>
              ...
              {invoiceForm?.statusIndex !== "2" && (
                <div className="w-full flex-1 my-1 sm:my-1 md:my-0 px-1">
                  ...
                  >
                    ...
                    {params.id === "new" ? "Pay Later" : "Update"}
                  </Button>
                </div>
              )}
              <div className="w-full flex-1 my-1 sm:my-1 md:my-0 px-1">
